...
const MedicalRecordsPage: React.FC = () => {
  ...
  return (
    <main className="p-6">
      ...
      >
        <TabsList className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 mb-6 w-full max-w-screen-md mx-auto text-black bg-[#2a515f] backdrop-blur-sm px-2 py-1 rounded-xl">
          <TabsTrigger
            value="medications"
