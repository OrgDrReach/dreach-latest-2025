		...
		<AnimatePresence>
			{isOpen && (
				<motion.div
					...
					<motion.div
						className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md mx-auto p-8"
						variants={modalVariants}>
						...
						{selectedDoctor && (
							<div className="mb-6 p-4 bg-gradient-to-br from-[#30acda]/10 to-[#2e5566]/10 rounded-xl">
						...
						<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
							...
							<div className="space-y-4">
								{[
									...
									{ icon: FaClock, label: "Time", field: "time", type: "time" },
