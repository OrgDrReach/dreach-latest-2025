...
const dashboardData: DashboardDataItem[] = [
	{
		...
		icon: <BarChart3 className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
	{
		id: 2,
		title: "Appointments",
		description: "Schedule and manage your visits",
		icon: <Calendar className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
	{
		id: 3,
		title: "Medical Records",
		description: "Access your health history",
		icon: <FolderArchive className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
	{
		id: 4,
		title: "Prescriptions",
		description: "View and manage medications",
		icon: <Pill className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
	{
		id: 5,
		title: "Lab Results",
		description: "Check your test results",
		icon: <Microscope className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
	{
		id: 6,
		title: "Billing",
		description: "Manage payments and insurance",
		icon: <CreditCard className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
	{
		id: 7,
		title: "Messages",
		description: "Communicate with your care team",
		icon: <MessageSquare className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
	{
		id: 8,
		title: "Pharmacy",
		description: "Order and track medications",
		icon: <Store className="w-8 h-8 text-[#125872] dark:text-[#31addb] group-hover:text-[#31addb] transition-colors duration-300" strokeWidth={1.5} />,
	},
];
			...
			<div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 rounded-2xl p-8 shadow-lg">
				<div className="max-w-3xl mx-auto text-center mb-12">
					...
					<p className="text-lg text-slate-600 dark:text-slate-300">
						Your comprehensive health management hub - everything you need in one place
					</p>
				</div>
