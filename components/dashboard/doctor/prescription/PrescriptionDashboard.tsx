...
import { EPrescriptionStatus, IPrescription } from "@/types/doctor.d.types"; // Update this import
...
const PrescriptionDashboard: React.FC = () => {
	...
	const handleAddPrescription = (
		...
		const prescription: IPrescription = {
			...
			date: new Date().toISOString().split("T")[0], // Add current date if not provided
		};
