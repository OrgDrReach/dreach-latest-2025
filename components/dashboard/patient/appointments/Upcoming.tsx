...
const Upcoming: React.FC = () => {
  ...
  const AppointmentCard: React.FC<{ appointment: Appointment }> = ({
    ...
    <div className="p-4">
      <Card className="h-full w-full bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-gray-500">
        <CardContent className="p-4">
          <div className="flex items-center space-x-2 mb-4">
            <CalendarIcon className="h-4 w-4 text-emerald-500" />
            <Badge
              variant="outline"
              className="bg-emerald-500 text-[10px] dark:bg-emerald-900  dark:text-emerald-300"
            >
